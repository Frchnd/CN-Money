const CACHE='cn-money-main-v042-sdk-loader-hotfix';
const CORE=['/','/index.html','/manifest.json','/icons/icon-192.png','/icons/icon-512.png','/sounds/click.wav','/sounds/cash.wav'];
