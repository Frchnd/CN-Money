-- CN MONEY MAIN v0.4
-- Merapikan kategori barang. Tidak menghapus transaksi/history.
...
begin
    ...
    -- Kategori lama digantikan oleh TELUR dan PROTEIN.
    update public.shopping_categories
    set deleted_at = now()
    where household_id = p_household_id
      and name = 'Telur & Protein Lain'
    ...
    values
        ...
        (p_household_id, 'Telur', 30),
        (p_household_id, 'Protein', 35),
        ...
        (p_household_id, 'Makanan Kaleng & Instan', 78),
